...
function copyProjectTemplateAndReplace(
  ...
  walk(srcPath).forEach(absoluteSrcFilePath => {
    ...
    const relativeRenamedPath = dotFilePath(relativeFilePath)
      .replace(/rnkotlin_template/g, safeProjectName)
      .replace(/rnkotlintemplate/g, newProjectName);
    ...
    copyAndReplace(
      ...
      {
        "RNkotlin DisplayName": options.displayName || newProjectName,
        rnkotlintemplate: newProjectName,
        rnkotlin_template: safeProjectName
